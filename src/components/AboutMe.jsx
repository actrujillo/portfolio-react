...
export default function AboutMe() {
  return (
    <>
      <Box p="1.5rem" minHeight="100vh" display="flex" flexWrap="wrap">
        <Text
          as="h2"
          color="grey.light"
          fontWeight="600"
        ...
        <Text as="p" color="grey.slate" mb="1rem" fontSize="1rem">
          <Text as="span" color="green" fontWeight="bold">
            Hello World!{" "}
          </Text>
          I'm Ariel, a programmer seeking a position as a FrontEnd Developer to
          continue my learning and development.
        </Text>
        <Text as="p" color="grey.slate" mb="1rem" fontSize="1rem">
        ...
        <Text as="p" color="grey.slate" mb="1rem" fontSize="1rem">
          ...
          time to personal care, in order to have peace of mind as well as ideas
          to implement.
        </Text>
        <Text as="p" color="grey.slate" mb="1rem" fontSize="1rem">
